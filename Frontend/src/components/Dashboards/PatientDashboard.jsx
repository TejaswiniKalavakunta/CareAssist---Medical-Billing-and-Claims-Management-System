...
const PatientDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div
        className="flex flex-col flex-grow bg-cover bg-center relative ml-[-2.5%]"
        style={{
      ...
      >
        ...
        <footer className="bg-zinc-50 text-center dark:bg-neutral-700 lg:text-left absolute bottom-0 left-4 w-full z-20">
