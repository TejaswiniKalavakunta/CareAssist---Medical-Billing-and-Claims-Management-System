...
import Admin from "D:/ReactHexaware/ReactApps/React_WS/careassist/src/assets/Admin.jpeg";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex flex-1">
        ...
        <div
          className="container ml-82 mr-12 w-3/4 bg-cover bg-center"
              ...
              {adminData.map((admin) => (
                ...
                >
                  ...
                  <Dropdown
                    ...
                    onLogout={() =>
                      handleDropdownChange(admin.adminId, "logout")
                    }
                  />
                </li>
              ))}
