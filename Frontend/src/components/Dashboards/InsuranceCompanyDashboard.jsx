  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex flex-grow">
        ...
        />
        <div
          className="container ml-64 mr-0 w-full bg-cover bg-center"
          style={{
            backgroundImage: `url(${InsuranceCompanyDashboardBg})`,
              ...
              {insuranceCompanyData.map((insuranceCompany) => (
                ...
                >
                  ...
                  <Dropdown
                    ...
                    onUpdateProfile={() =>
                      handleDropdownChange(insuranceCompany.companyId, "update")
                    }
                    onLogout={() =>
                      handleDropdownChange(insuranceCompany.companyId, "logout")
                    }
                  />
                </li>
              ))}
