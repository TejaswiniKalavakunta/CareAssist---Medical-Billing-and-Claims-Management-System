...
//       alert(`Claim ${selectedClaim.claimId} status updated successfully`);
...
//       claim.patientId.toString().includes(searchTerm.toLowerCase())
//   );
...
//             <h2 className="text-lg font-semibold mb-4">Update Claim Status</h2>
...
const ClaimManagement = () => {
  ...
  useEffect(() => {
    if (viewingClaims) {
      ...
      // Add logic to fetch all patients or any other relevant initialization for managing insurance plans
    }
  }, [viewingClaims]); // Fetch data based on the selected functionality
  ...
  return (
    <div className="container mx-auto">
      ...
      {viewingClaims ? (
        ...
        // Rendering PatientInsurancePlan component for managing insurance plans
